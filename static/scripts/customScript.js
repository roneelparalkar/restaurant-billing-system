...
const collapseOpenModalAndDD = () => {
  const profileDDContainer = $('.app-header-right .widget-content-left')
  profileDDContainer.find('.btn-group').removeClass('show')
  profileDDContainer.find('.dropdown-menu-right').removeClass('show')
  $('.app-header__content').removeClass('header-mobile-open')
}

const initializeWebJS = () => {
  mobHeaderProfileDDBinding()
  sideMenuBtnBinding()
  profileDDBinding()
  sideMenuBinding()
  windowClickForDefaultCollapse()
}

const mobHeaderProfileDDBinding = () => {
  let mobHeaderBtn = $('.app-header__menu .mobile-toggle-header-nav')
  mobHeaderBtn.on('click', (e) => {
    e.stopPropagation()
    $('.app-header__content').toggleClass('header-mobile-open')
    let profileDDContainer = $('.app-header-right .widget-content-left')
    profileDDContainer.find('.btn-group').toggleClass('show')
    profileDDContainer.find('.dropdown-menu-right').toggleClass('show')
  })
}

const profileDDBinding = () => {
  let profileDDContainer = $('.app-header-right .widget-content-left')
  profileDDContainer.on('click', (e) => {
    e.stopPropagation()
    profileDDContainer.find('.btn-group').toggleClass('show')
    profileDDContainer.find('.dropdown-menu-right').toggleClass('show')
  })
...
const sideMenuBinding = () => {
  $(window).on('resize', resizeSideMenu)
}

const sideMenuBtnBinding = () => {
  let webSideMenuBtn = $('.app-header .header__pane button')
  webSideMenuBtn.on('click', function () {
    toggleSideMenu(this)
  })

  let mobSideMenuBtn = $('.app-header .app-header__mobile-menu button')
  mobSideMenuBtn.on('click', function () {
    $('.app-container').toggleClass('sidebar-mobile-open')
    toggleSideMenu(this)
  })
}

const toggleSideMenu = (elemRef) => {
  // elemRef.toggleClass('is-active')
  $('.app-container').toggleClass('closed-sidebar')
}

const windowClickForDefaultCollapse = () => {
  $(window).on('click', collapseOpenModalAndDD)
}
...
window.onload = () => {
  if (!window.location.pathname.includes('/login')) window.bindJsEvents()
}
